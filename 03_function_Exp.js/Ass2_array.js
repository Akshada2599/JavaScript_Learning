...
//console.log("=============================================================================");
console.warn(`===========The total elements available or length and log on console===========`);
const total_length = array_numbers.length;
console.log("Total length of Array :")
console.log(total_length);

//console.log("=============================================================================");
console.warn("===========Log the first and last element in array_numbers and log on console================");
...
//console.log("===============================================================================");
console.warn("============Log the third last element using length property and log on console=============")
 let last =array_numbers[array_numbers.length-3];
 console.log(last);

 //console.log("==============================================================================");
 console.warn("===============find all even numbers and log on console======================");
 var res = "";
for (let index= 0; index < array_numbers.length; index++) {
 ...
 //console.log("===================================================================================");
 console.warn("================find the odd number and log on console=======================");
...
//console.log("========================================================================================");
console.warn("====================find all even positioned element from array_numbers for loop==============")
var result = "";
for (let index = 0; index < array_numbers.length; index++) {
    if([index]%2==0)
    { 
...
console.warn("==============find all odd positioned element from array_numbers for loop===============")
var rm ="";
for (let index = 0; index < array_numbers.length; index++) {
      if([index]%2!==0)
      {
...
//console.log("============================================================================================");
console.warn("================find the sum of all elements from array_numbers,log on console==================")
      var sum =0;
      for (let index = 0; index < array_numbers.length; index++) {
...
//console.log("=========================================================================================");
console.warn("===============is number 115 availbale in array_numbers======================");
console.log(array_numbers.includes(115));
//console.log("=============================================================================================");
console.warn("============is number 23 available in array_numbers========================");
